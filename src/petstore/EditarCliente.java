...
public class EditarCliente extends javax.swing.JFrame {
    ...
    public EditarCliente(Cliente cliente) {
        initComponents();
        desabilitaDados();
        txtID.setText(cliente.getId_cliente().toString());
        txtNome.setText(cliente.getNome());
        txtDtNasc.setText(cliente.getData_nasc());
        cmbSexo.setSelectedItem(cliente.getSexo());
        cmbEstadoCivil.setSelectedItem(cliente.getEstado_civil());
        txtProfissao.setText(cliente.getProfissao());
        txtRG.setText(cliente.getRg());
        txtCPF.setText(cliente.getCpf());
        cmbLogradouro.setSelectedItem(cliente.getLogradouro());
        ...
        txtTelRes.setText(cliente.getTel_res());
        txtTelCom.setText(cliente.getTel_com());
    ...
    private void initComponents() {
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtCEP, txtCidade});
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtProfissao, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void alteraCadastroCliente() {
        Cliente cliente = new Cliente();
        ClienteDao dao;
        try {
            dao = new ClienteDao();
            cliente.setId_cliente(Long.valueOf(txtID.getText()));
            cliente.setNome(txtNome.getText());
            cliente.setData_nasc(txtDtNasc.getText());
            cliente.setSexo(cmbSexo.getSelectedItem().toString());
            cliente.setEstado_civil(cmbEstadoCivil.getSelectedItem().toString());
            cliente.setProfissao(txtProfissao.getText());
            cliente.setRg(txtRG.getText());
            cliente.setCpf(txtCPF.getText());
            cliente.setLogradouro(cmbLogradouro.getSelectedItem().toString());
            cliente.setEndereco(txtEndereco.getText());
            cliente.setNumero(Long.valueOf(txtNum.getText()));
            cliente.setBairro(txtBairro.getText());
            cliente.setCep(txtCEP.getText());
            cliente.setCidade(txtCidade.getText());
            cliente.setUf(cmbUF.getSelectedItem().toString());
            cliente.setTel_res(txtTelRes.getText());
            cliente.setTel_com(txtTelCom.getText());
            cliente.setEmail(txtEmail.getText());
            dao.altera(cliente);
            JOptionPane.showMessageDialog(null, "Cadastro do cliente alterado com sucesso", "Informação", 1);
        } catch (SQLException ex) {
